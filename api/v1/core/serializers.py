...
class APILogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'response_time_ms', 'user', 'user_username',
...
class SystemLogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SystemLog
        fields = [
            'id', 'level', 'level_display', 'source',
            'message', 'details', 'created_at',
        ]
        read_only_fields = fields
        extra_kwargs = {
            'id':         {'help_text': 'Unique system log entry ID.'},
            'level':      {'help_text': 'Severity level: `DEBUG`, `INFO`, `WARNING`, `ERROR`, or `CRITICAL`.'},
...
class SystemSettingsSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        extra_kwargs = {
            ...
            'value':        {
                'write_only': True,
                'help_text': 'The setting value (write-only). Sensitive values are masked in responses.',
            },
